        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    EnquiryType = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    StudentId = table.Column<int>(type: "int", nullable: false),
                    CourseID = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "2845cc7f-159c-4bce-a281-4540b535dd92", "2", "Student", "STUDENT" },
                    { "383eb2c6-79f8-42d6-8a7a-ff1cb8f2d12d", "1", "Admin", "ADMIN" },
                    { "eaa3779a-4530-4753-999d-23be73e67439", "3", "OfficeStaff", "OFFICESTAFF" }
                });
